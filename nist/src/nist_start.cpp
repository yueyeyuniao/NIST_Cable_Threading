...
class nist_task
{
	public: 
	    ...
	    void Insert()
	    {
			...
			insert_pose.position.y = transform_insert.getOrigin().y()-0.01;
		...
		{	// old
			...
			geometry_msgs::Pose pose;
			pose.position.x = 0.379;
			pose.position.y = 0.044;
			pose.position.z = 0.471;
			pose.orientation.x = 0.707;
			pose.orientation.y = 0.707;
			pose.orientation.z = 0.025;
			pose.orientation.w = 0.025;
			Motion(pose,0.8);
		}
		...
		void GoToPre_tube1_tube2()
		{
			...
			pose.position.z = 0.255;
			pose.orientation.x = 0.681;
			pose.orientation.y = 0.685;
			pose.orientation.z = 0.184;
			pose.orientation.w = 0.182;
		...
		{
			geometry_msgs::Pose pose;
			pose.position.x = 0.341;
			pose.position.y = 0.046;
			pose.position.z = 0.206;
			pose.orientation.x = 0.667;
			pose.orientation.y = 0.667;
			pose.orientation.z = 0.234;
			pose.orientation.w = 0.234;
		...
		void GoToReady_tube1_tube2_2()
		{
			...
			pose.position.y = 0.048;
			pose.position.z = 0.251;
			pose.orientation.x = 0.694;
			pose.orientation.y = 0.715;
			pose.orientation.z = 0.067;
			pose.orientation.w = 0.050;
		...
		{
			geometry_msgs::Pose pose;
			pose.position.x = 0.562;
			pose.position.y = 0.159;
			pose.position.z = 0.419;
			pose.orientation.x = 0.999;
			pose.orientation.y = 0.001;
			pose.orientation.z = 0.003;
			pose.orientation.w = -0.054;
		...
		{	
			...
			sleep(0.5);
			geometry_msgs::Pose pose_target;
			// pose_target.position.x = transform_base_cable.getOrigin().x();
			// pose_target.position.y = transform_base_cable.getOrigin().y();
			// pose_target.position.z = transform_base_cable.getOrigin().z()+0.215;
			...
			// pre-grasp
			pose_target.position.x = 0.376;
			pose_target.position.y = 0.064;
			pose_target.position.z = 0.294;
			pose_target.orientation.x = -0.652;
			pose_target.orientation.y = 0.758;
			pose_target.orientation.z = -0.020;
			pose_target.orientation.w = 0.004;

			Motion(pose_target,0.8);

			pose_target.position.x = 0.393;
			pose_target.position.y = 0.051;
			pose_target.position.z = 0.240;
			pose_target.orientation.x = -0.614;
			pose_target.orientation.y = 0.790;
			pose_target.orientation.z = 0.004;
			pose_target.orientation.w = 0.009;
			...
			pose_target.position.x = 0.396;
			pose_target.position.y = 0.045;
			pose_target.position.z = 0.248;
			pose_target.orientation.x = 0.333;
			pose_target.orientation.y = 0.943;
			pose_target.orientation.z = 0.010;
			pose_target.orientation.w = 0.003;
			Motion(pose_target,0.5);
			sleep(1.0);
			...
			pose_target.position.y = transform_base_ee.getOrigin().y() + 0.028;
...
//			sleep(1.0);
			geometry_msgs::Pose pose_target;
			pose_target.position.x = 0.368;
			pose_target.position.y = 0.144;
			pose_target.position.z = 0.245;
			pose_target.orientation.x = 0.009;
			...
			// if cable slipped in the finger
			// pose_target.position.x = 0.369;
			// pose_target.position.y = 0.365;
			// pose_target.position.z = 0.276;
			// pose_target.orientation.x = 0.009;
			// pose_target.orientation.y = 1.000;
			// pose_target.orientation.z = 0.001;
			// pose_target.orientation.w = 0.003;

			// if cable did not slip in the finger
			pose_target.position.x = 0.369;
			pose_target.position.y = 0.257;
			pose_target.position.z = 0.276;
			pose_target.orientation.x = 0.009;
			pose_target.orientation.y = 1.000;
			pose_target.orientation.z = 0.001;
			...
			// ready to insert to the final holder
			pose_target.position.x = 0.348;
			pose_target.position.y = 0.179;
			pose_target.position.z = 0.335;
			pose_target.orientation.x = 1.000;
			pose_target.orientation.y = 0.017;
			...
			// now we can use the visual servoing to insert to the final holder, same as to tube 1
...
int main(int argc, char **argv)
{
	...
	// insert to holder
	// nist_cool.Insert_visual_servoing("holder");
